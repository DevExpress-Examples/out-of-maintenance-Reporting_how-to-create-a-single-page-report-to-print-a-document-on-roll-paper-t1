...
Namespace SinglePageReport
    ...
    Public Module SinglePageHelper
        ...
        Public Sub GenerateSinglePageReport(ByVal report As XtraReport)
            ...
            Call XtraPageSettingsBase.ApplyPageSettings(pageSettings, DXPaperKind.Custom, New Size(pageSettings.Bounds.Width, pageSettings.Bounds.Height * report.Pages.Count), pageSettings.Margins, pageSettings.MinMargins, pageSettings.Landscape)
            ...
            Call XtraPageSettingsBase.ApplyPageSettings(pageSettings, DXPaperKind.Custom, New Size(pageSettings.Bounds.Width, totalPageHeight), pageSettings.Margins, pageSettings.MinMargins, pageSettings.Landscape)
        End Sub
    End Module
End Namespace
